...
db.once('open', async () => {
  ...
  const products = await Product.insertMany([
    ...
    {
      productName: 'Suede Lounger',
      category: categories[0]._id,
      description: 'Suede matte lounge chair',
      image: 'suede-lounger.jpg',
      price: 160.00,
      quantity: 20,
    },
    {
      ...
      category: categories[0]._id,
      description: 'Wooden vintage antique chair with wooden feet',
      image: 'antique-chair.png',
      price: 90.00,
      quantity: 10,
    },
    {
      productName: 'Antique Sofa',
      category: categories[1]._id,
      description: 'White antique style vintage sofa',
      image: 'antique-sofa.jpg',
      price: 500.00,
      quantity: 5,
    },
    {
      ...
      category: categories[2]._id,
      description: 'Stackable wooden vintage antique table',
      image: 'antique-table.png',
      price: 130.00,
      quantity: 25,
    },
    {
      productName: 'Antique Dresser',
      category: categories[3]._id,
      description: 'Wooden antique vintage dresser with white lining',
      image: 'antique-dresser.png',
      price: 300.00,
      quantity: 15,
    },
    {
      productName: 'Antique Bed',
      category: categories[4]._id,
      description: 'Wooden antique vintage bed',
      image: 'antique-bed.png',
      price: 1000.00,
      quantity: 8,
    },
  ]);
